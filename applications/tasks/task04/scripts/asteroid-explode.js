class asteroidExplode extends Phaser.Scene 
{
    ...
    preload()
    {
        ...
        //new particle here
        this.load.image('explosionParticle', './assets/asteriod_explosion.png'); // Path to your particle texture
    }
...
function laserVsRock(collisionData)
{
    ...
    //new particle effect HERE
    const particles = rock.scene.add.particles('explosionParticle');
    ...
    // Destroy the particle system after the explosion
    rock.scene.time.delayedCall(1000, () => {
        particles.destroy();
    });
}
